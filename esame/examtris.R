...
# AGGIUNTA DI UNA VARIABILE ALLA VOLTA NEL MODELLO PREDITIVO DT #
# Installa e carica i pacchetti necessari, se non lo hai già fatto
...
other_features <- setdiff(names(injury_df), c("Injury_Occurred", base_features))
...
# Puoi visualizzare tutti i risultati alla fine
print("--- Riepilogo dei risultati per ogni modello ---")
for (feature in names(results)) {
  cat(paste0("\nModello con l'aggiunta di: ", feature, "\n"))
